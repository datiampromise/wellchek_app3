      ...
      <div className="onboarding-header">
        ...
        <form>
          ...
          <div className="form-group">
            ...
            <input
              type="checkbox"
              name="four-to-six-hours"
              id="four-to-six-hours"
            />
          </div>
          <div className="form-group">
            <label htmlFor="ten-hours-above">
              <span>
                <Link to="/onboarding/3">10hrs and above</Link>
              </span>
            </label>
            <input
              type="checkbox"
              name="ten-hours-above"
              id="ten-hours-above"
            />
          </div>
        </form>
...
export const OnboardingThirdPage = () => {
  ...
  return (
    <div className="onboarding">
      <div className="onboarding-header">
        <p className="onboarding_subtitle large">
          Do you experience difficulty fall asleep, staying asleep or waking up
          too early?
        </p>
        <form>
          <div className="form-group">
          ...
          {!showContext && (
            <>
              <div className="form-group">
                <label htmlFor="no">
                  <span onClick={toggleContextShow}>No</span>
                </label>
          ...
          {showContext && (
            <>
              ...
              <p className="context">
                Recognizing how you sleep is an important part of the process,
